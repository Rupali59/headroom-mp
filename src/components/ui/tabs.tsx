...
const tabsListVariants = cva(
  // design-system/MASTER.md §6 target-size sweep: 44px (AAA), not the
  // generated 32px — TabsTrigger's height is `calc(100%-1px)` of this list,
  // so raising it here is the whole fix.
